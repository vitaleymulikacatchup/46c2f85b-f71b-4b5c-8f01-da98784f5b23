...
export const metadata: Metadata = {
  title: "Fresh Local Groceries | GroceryShop Ukraine",
  description: "Quality produce from local farms at affordable prices. Shop fresh vegetables and fruits in your neighborhood.",
  keywords: "local groceries, fresh produce, vegetables, fruits, Ukraine, farm fresh",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Fresh Local Groceries | GroceryShop",
    description: "Quality produce from local farms at affordable prices",
    type: "website",
    siteName: "GroceryShop Ukraine"
  }
};
